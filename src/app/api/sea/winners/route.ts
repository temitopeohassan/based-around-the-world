...
import projects from '../../../winners-sea.json';
...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  return new NextResponse(
    getFrameHtmlResponse({
      ...
      image: `${NEXT_PUBLIC_URL}/api/sea/og?project=${encodeURIComponent(currentProject.name)}&description=${encodeURIComponent(currentProject.description)}&index=${currentIndex + 1}&total=${projects.length}`,
      post_url: `${NEXT_PUBLIC_URL}/api/sea/winners`,
