...
import winners from '../../../winners-latam.json';
...
export async function POST(req: NextRequest): Promise<NextResponse> {
  try {
          ...
          buttons: [
            {
              label: 'View Projects',
              action: 'post',
              postUrl: `${NEXT_PUBLIC_URL}/api/latam/projects`,
            },
            {
              label: 'View Winners',
              action: 'post',
              postUrl: `${NEXT_PUBLIC_URL}/api/latam/winners`,
            },
          ],
          image: `${NEXT_PUBLIC_URL}/latam/buildathon.png`,
          post_url: `${NEXT_PUBLIC_URL}/api/latam/projects`,
        })
      );
    }
    ...
    const imageUrl = `${NEXT_PUBLIC_URL}/latam/${currentProject.image}`;
    ...
    const response = new NextResponse(
      getFrameHtmlResponse({
        ...
        image: imageUrl,
        post_url: `${NEXT_PUBLIC_URL}/api/latam/winners`,
